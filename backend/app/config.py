...
class Settings:
    ...
    API_DESCRIPTION: str = os.getenv(
        "API_DESCRIPTION",
        "Enterprise-grade Store Management API designed to showcase backend architecture, business rules, and cloud-ready design.",
    )

    # Security
    SECRET_KEY: str = os.getenv(
        "SECRET_KEY", "to-be-changed-in-production-use-openssl-rand-hex-32"
    )
